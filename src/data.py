...
def load_data(filepath, class_column=-1):
...
def load_dataset(filepath, class_column=-1, n_splits=10, test_size=0.3):
	...
	# Loads the data
	data = load_data(filepath, class_column)

	# Creates a Dataset object and returns it
	return Dataset(data, n_splits, test_size)